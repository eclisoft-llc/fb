...
@XmlType(name = "tRspHdr", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", propOrder = {
    "rspHdrVer",
    "rtnCde",
    "msgUuid",
    "actyId",
...
public class TRspHdr {
    ...
    public static class ServPrmtrsLst {
        ...
        @XmlElement(name = "ServPrmtrs", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
        ...
        public static class ServPrmtrs {
            ...
            @XmlElement(name = "FeId", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
            protected String feId;
            @XmlElement(name = "ServId", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
            protected String servId;
            @XmlElement(name = "ServVer", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
            protected String servVer;
            @XmlElement(name = "ApplId", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
            ...
            @XmlElement(name = "FldLst", namespace = "https://www.firstbankonline.com/FisCommonRspHdr")
            ...
            public static class FldLst {
                ...
                @XmlElement(name = "Fld", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
                ...
                public static class Fld {
                    ...
                    @XmlElement(name = "FldNme", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
                    protected String fldNme;
                    @XmlElement(name = "FldVal", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
