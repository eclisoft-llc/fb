 ...
 * 
 */
@XmlRootElement(name="XPRetrieveIpAnlytcsMktDtlRsp")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XPRetrieveIpAnlytcsMktDtlRsp", namespace = "https://www.firstbankonline.com/XPRetrieveIpAnlytcsMktDtlRsp", propOrder = {
    "rspHdr",
    "xpRtrvIpAnlytcsMktDtlOso"
})
public class XPRetrieveIpAnlytcsMktDtlRsp {

    @XmlElement(name = "RspHdr", namespace = "https://www.firstbankonline.com/FisCommonRspHdr", required = true)
