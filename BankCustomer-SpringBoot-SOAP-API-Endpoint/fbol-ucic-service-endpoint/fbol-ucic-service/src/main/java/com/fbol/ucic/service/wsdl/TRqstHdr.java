...
@XmlType(name = "tRqstHdr", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", propOrder = {
    "rqstHdrVer",
    "msgUuid",
    "srcId",
    "actyId",
...
public class TRqstHdr {
    ...
    public static class Sec {
        ...
        @XmlElement(name = "Trusted", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
        protected String trusted;
        @XmlElement(name = "BasicAuthen", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
        protected TRqstHdr.Sec.BasicAuthen basicAuthen;
        @XmlElement(name = "SessAuthen", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
        protected TRqstHdr.Sec.SessAuthen sessAuthen;
        @XmlElement(name = "TokenAuthen", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
        protected TRqstHdr.Sec.TokenAuthen tokenAuthen;
        @XmlElement(name = "WsSec", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
        ...
        public static class BasicAuthen {
            ...
            @XmlElement(name = "UsrId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
            protected String usrId;
            @XmlElement(name = "Pswrd", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
        ...
        public static class SessAuthen {
            ...
            @XmlElement(name = "SessId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
            protected String sessId;
            @XmlElement(name = "HttpSessId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
    ...
    public static class ServPrmtrsLst {
        ...
        @XmlElement(name = "ServPrmtrs", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
        ...
        public static class ServPrmtrs {
            ...
            @XmlElement(name = "FeId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
            protected String feId;
            @XmlElement(name = "ServId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
            protected String servId;
            @XmlElement(name = "ServVer", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
            protected String servVer;
            @XmlElement(name = "ApplId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
            protected String applId;
            @XmlElement(name = "DataLnkId", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
            protected String dataLnkId;
            @XmlElement(name = "FldLst", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr")
            ...
            public static class FldLst {
                ...
                @XmlElement(name = "Fld", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
                ...
                public static class Fld {
                    ...
                    @XmlElement(name = "FldNme", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
                    protected String fldNme;
                    @XmlElement(name = "FldVal", namespace = "https://www.firstbankonline.com/FisCommonRqstHdr", required = true)
