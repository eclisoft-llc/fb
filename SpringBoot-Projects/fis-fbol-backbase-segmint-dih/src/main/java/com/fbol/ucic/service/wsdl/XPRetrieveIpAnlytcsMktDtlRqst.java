 ...
 * 
 */
@XmlRootElement(name="XPRtrvIpAnlytcsMktDtlRqst", namespace="XPRetrieveIpAnlytcsMktDtlRqst")
@XmlSeeAlso({UsernameToken.class})
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XPRetrieveIpAnlytcsMktDtlRqst", namespace = "XPRetrieveIpAnlytcsMktDtlRqst", propOrder = {
    "rqstHdr",
    "xpRtrvIpAnlytcsMktDtlOsi"
})
public class XPRetrieveIpAnlytcsMktDtlRqst {

    @XmlElement(name = "RqstHdr", namespace = "FisCommonRqstHdr", required = true)
